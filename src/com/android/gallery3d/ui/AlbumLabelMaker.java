...
public class AlbumLabelMaker {
    ...
    public ThreadPool.Job<Bitmap> requestLabel(String label) {
        return new AlbumLabelJob(label);
    }
    ...
    private class AlbumLabelJob implements ThreadPool.Job<Bitmap> {
        ...
        public AlbumLabelJob(String label) {
            mLabel = label;
        }

        @Override
        public Bitmap run(JobContext jc) {
            AlbumSlotRenderer.LabelSpec spec = mSpec;
            ...
            //Logger.d(TAG, "AlbumLabelJob - x: " + x + " y: " + y + " labelWidth: " + labelWidth);
...
//            drawText(canvas, x, y, "x", labelWidth - x, mLabelPaint);
