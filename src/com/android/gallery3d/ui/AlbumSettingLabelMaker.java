...
public class AlbumSettingLabelMaker {
    private static final String TAG = "AlbumSettingLabelMaker";
    private static final int BORDER_SIZE = 0;

    private final AlbumSettingSlotRenderer.LabelSpec mSpec;
    ...
    public AlbumSettingLabelMaker(Context context, AlbumSettingSlotRenderer.LabelSpec spec) {
        mContext = context;
        mSpec = spec;
    ...
    private class AlbumLabelJob implements ThreadPool.Job<Bitmap> {
        ...
        public Bitmap run(JobContext jc) {
            AlbumSettingSlotRenderer.LabelSpec spec = mSpec;
