...
public class AlbumSlotRenderer extends AbstractSlotRenderer {
    ...
    protected final AlbumSlotRenderer.LabelSpec mLabelSpec;
    ...
    public AlbumSlotRenderer(AbstractGalleryActivity activity, SlotView slotView,
                             AlbumSlotRenderer.LabelSpec labelSpec, SelectionManager selectionManager, int placeholderColor) {
        super(activity);
        mActivity = activity;
        mSlotView = slotView;
    ...
    protected int renderLabel(GLCanvas canvas, AlbumSlidingWindow.AlbumEntry entry, int width, int height) {
    ...
    private class MyDataModelListener implements AlbumSlidingWindow.Listener {
        ...
        public void onContentChanged() {
            //Logger.d(TAG,"AlbumSlidingWindow.Listener - onContentChanged");
            mSlotView.invalidate();
        }

        @Override
        public void onSizeChanged(int size) {
            //Logger.d(TAG,"AlbumSlidingWindow.Listener - onSizeChanged size: " + size);
            mSlotView.setSlotCount(size);
            //Photo won't disappear when it has been deleted
            mSlotView.invalidate();
        }
    }
