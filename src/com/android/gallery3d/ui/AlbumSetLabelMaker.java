...
public class AlbumSetLabelMaker {
    private static final String TAG = "AlbumSetLabelMaker";
    ...
    public AlbumSetLabelMaker(Context context, AlbumSetSlotRenderer.LabelSpec spec) {
        mContext = context;
        mSpec = spec;
    ...
    private class AlbumLabelJob implements ThreadPool.Job<Bitmap> {
        ...
        public Bitmap run(JobContext jc) {
            AlbumSetSlotRenderer.LabelSpec spec = mSpec;
