...
public class TimeLineTitleMaker {
    ...
    private final int TIMELINETITLE_START_X = 0;
    ...
    public ThreadPool.Job<Bitmap> requestTimeLineTitle(String title, int photoCount, int videoCount) {
        return new TimeLineTitle(title, photoCount, videoCount, mContext);
    }

    void drawText(Canvas canvas, int x, int y, String text, int lengthLimit, TextPaint p) {
    ...
    private class TimeLineTitle implements ThreadPool.Job<Bitmap> {
        ...
        public Bitmap run(JobContext jc) {
            ...
            if (bitmap == null) {
                ...
                bitmap = Bitmap.createBitmap(width + borders, height + borders, Config.ARGB_8888);
            }
            if (bitmap == null) {
                return null;
            }
            ...
            canvas.drawColor(spec.timeLineTitleBackgroundColor, PorterDuff.Mode.SRC);
            ...
            if (mImageCount != 0) {
                ...
                if (mVideoCount != 0) {
                    sb.append("  " + mContext.getResources().getQuantityString(R.plurals.number_of_videos, mVideoCount, mVideoCount));
                }
            } else {
                if (mVideoCount != 0) {
                    sb.append(mContext.getResources().getQuantityString(R.plurals.number_of_videos, mVideoCount, mVideoCount));
            ...
            String countString = null;//sb.toString();
            ...
            if (mTitle != null) {
                ...
                if (View.LAYOUT_DIRECTION_RTL == TextUtils.getLayoutDirectionFromLocale(Locale.getDefault())) {
                    ...
                    mTitlePaint.getTextBounds(mTitle, 0, width, titleBounds);
            ...
            if (countString != null) {
                ...
                mCountPaint.getTextBounds(countString, 0, width, mediaCountBounds);
                ...
                drawText(canvas, x, y, countString, width - x, mCountPaint);
            }
            return bitmap;
        }
    }
