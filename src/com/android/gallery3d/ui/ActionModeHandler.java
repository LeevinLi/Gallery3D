...
public class ActionModeHandler implements Callback, PopupList.OnPopupItemClickListener {
    ...
    private static final int SUPPORT_MULTIPLE_MASK = MediaObject.SUPPORT_DELETE |
            MediaObject.SUPPORT_ROTATE |
            MediaObject.SUPPORT_MOVE |
    ...
    private void updateSelectionMenu() {
        ...
        if(count == 0){
            String title=mActivity.getString(R.string.please_select);
            setTitle(title);
        }else {
            setTitle("" + count);
        }
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        ...
        if (mSharePanoramaMenuItem != null) {
            mSharePanoramaActionProvider = (ShareActionProvider) mSharePanoramaMenuItem.getActionProvider();
            mSharePanoramaActionProvider.setOnShareTargetSelectedListener(mShareTargetSelectedListener);
        ...
        if (mShareMenuItem != null) {
            ...
            mShareActionProvider.setOnShareTargetSelectedListener(mShareTargetSelectedListener);
        ...
        mMenuTask = mActivity.getThreadPool().submit(new Job<Void>() {
            ...
            public Void run(final JobContext jc) {
                ...
                final Intent share_panorama_intent = canSharePanoramas ?
                        computePanoramaSharingIntent(jc, MAX_SELECTED_ITEMS_FOR_PANORAMA_SHARE_INTENT) : new Intent();
