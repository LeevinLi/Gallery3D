...
public class GalleryUtils {
    ...
    public static final String MEDIA_IMAGE_COLUMNS_IS_HIDDEN = "is_hidden";
    public static final String EXTRA_DEFAULT_FILE_NAME = "pic.png";
    public static final String EXTRA_MOVE_IMAGE_COUNT = "move-image-count";
    public static final String EXTRA_MOVE_VIDEO_COUNT = "move-video-count";
    public static final String EXTRA_ALBUM_STATUS = "extra.album.status";
    public static final String ACTION_VIEW_GIF = "com.android.gallery3d.VIEW_GIF";
    public static final boolean SUPPORT_3D = false;
    public static final boolean SUPPORT_SETTING_HIDDEN = false;
    public static final String NA = "N/A";
    public static final String PANORAMAS_TITLE = "PANO_%";
    public static final String EXTRA_FILE_PROVIDER_AUTHORY = "com.android.gallery3d.FILE.PROVIDER";
    ...
    public static void assertNotInRenderThread() {
        if (!sWarned) {
            if (Thread.currentThread() == sCurrentThread) {
                sWarned = true;
                Logger.w(TAG, new Throwable("Should not do this in render thread"));
            }
        }
    }
    ...
    public static boolean isRootPath(String path) {
        ...
        return rootPath.equalsIgnoreCase(path);
    }
        ...
        try {
            ...
            try {
                ...
                ((Activity) context).runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(context, context.getString(R.string.fail_to_load), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public static boolean isFullScreen(final Window window) {
        ...
        if ((flag & WindowManager.LayoutParams.FLAG_FULLSCREEN) == 0) {
            return true;
        }
        return false;
    }
