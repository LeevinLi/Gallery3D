...
public class StringTexture extends CanvasTexture {
    ...
    public static TextPaint getDefaultPaint(float textSize, int color) {
        return getDefaultPaint(textSize, color, true);
    }

    public static TextPaint getDefaultPaint(float textSize, int color, boolean shadow) {
    ...
    public static StringTexture newInstance(String text, float textSize, int color, boolean isShadow) {
        return newInstance(text, getDefaultPaint(textSize, color, isShadow));
    }

    public static StringTexture newInstance(String text, float textSize, int color, boolean isShadow, boolean isBold) {
        TextPaint paint = getDefaultPaint(textSize, color, isShadow);
        if (isBold) {
