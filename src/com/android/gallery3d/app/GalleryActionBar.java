...
import com.android.gallery3d.data.ActionTab;
...
public class GalleryActionBar implements OnNavigationListener, TabListener {
    ...
    private List<ActionTab> mTabsList = new ArrayList<ActionTab>(2);

    private TabSelectedListenter mSelectedListenter;
    ...
    public void enableAlbumModeMenu(int selected, OnAlbumModeSelectedListener listener) {
        if (mActionBar != null) {
            if (mAlbumModeAdapter == null) {
                ...
                mAlbumModes = new CharSequence[]{res.getString(R.string.switch_photo_filmstrip), res.getString(R.string.switch_photo_grid)};
    ...
    public GalleryActionBar(AbstractGalleryActivity activity) {
        ...
        mCurrentIndex = 0;
        mTabsList.add(new ActionTab(activity.getResources().getString(R.string.appwidget_title), TimeLinePage.class));
        mTabsList.add(new ActionTab(activity.getResources().getString(R.string.albums), AlbumSetPage.class));
    }
    ...
    public void showActionTab() {
        ...
        try {
            Method setHasEmbeddedTabsMethod = mActionBar.getClass().getDeclaredMethod("setHasEmbeddedTabs", boolean.class);
            setHasEmbeddedTabsMethod.setAccessible(true);
            setHasEmbeddedTabsMethod.invoke(mActionBar, true);
        } catch (Exception ignore) {
        }
        Logger.d(TAG, "count  " + mActionBar.getTabCount());
        for (ActionTab tab : mTabsList) {
            if (mActionBar.getTabCount() == 2) {
                break;
            }
            Tab t = mActionBar.newTab();
    ...
    public void setTabSelectedListenter(TabSelectedListenter mListenter) {
        this.mSelectedListenter = mListenter;
    }
    ...
    public void onTabSelected(Tab tab, FragmentTransaction fragmentTransaction) {
        Logger.d(TAG, "onTabSelected - position: " + tab.getPosition());
        mSelectedListenter.onTabSelected(tab.getPosition());
    }
    ...
    public void onTabReselected(Tab tab, FragmentTransaction fragmentTransaction) {
        //Logger.d(TAG, "onTabReselected - position: " + tab.getPosition());
    }

    public interface TabSelectedListenter {
