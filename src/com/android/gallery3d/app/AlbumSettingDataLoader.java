...
public class AlbumSettingDataLoader {
    @SuppressWarnings("unused")
    private static final String TAG = "AlbumSettingDataLoader";
    ...
    public AlbumSettingDataLoader(AbstractGalleryActivity activity, MediaSet albumSet, int cacheSize) {
        mSource = Utils.checkNotNull(albumSet);
        mCoverItem = new MediaItem[cacheSize][3];
        ...
        public void run() {
            ...
            while (mActive) {
                ...
                if (info.index != INDEX_NONE) {
                    ...
                    info.cover = info.item.getCoverMediaItem2();
