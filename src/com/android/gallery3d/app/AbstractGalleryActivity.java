...
import com.android.gallery3d.data.AlbumsManager;
...
public class AbstractGalleryActivity extends Activity implements GalleryContext {
    ...
    public AlbumsManager getAlbumsManager() {
        return ((GalleryApp) getApplication()).getAlbumsManager();
    }
    ...
    public void printSelectedImage(Uri uri) {
        ...
        try {
            ...
            Logger.e(TAG, "Error printing an image", fnfe);
        }
    }

    public void showToast(int paramInt) {
        if (mToastText == null) {
            mToastText = Toast.makeText(this, paramInt, Toast.LENGTH_SHORT);
        }
        mToastText.setText(paramInt);
        mToastText.show();
    }

    public void showToast(String paramString) {
        if (mToastText == null) {
            mToastText = Toast.makeText(this, paramString, Toast.LENGTH_SHORT);
        }
        mToastText.setText(paramString);
        mToastText.show();
    }
}
