...
public class AlbumSelectionDataLoader {
    @SuppressWarnings("unused")
    private static final String TAG = "AlbumSelectionDataLoader";
    ...
    public AlbumSelectionDataLoader(AbstractGalleryActivity activity, MediaSet albumSet, int cacheSize) {
