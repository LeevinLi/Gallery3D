                ...
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (mMuteProgress != null) {
                            ...
                            Uri cUri = FileProvider.getUriForFile(mActivity, GalleryUtils.EXTRA_FILE_PROVIDER_AUTHORY, mDstFileInfo.mFile);
                            Logger.d(TAG,"save uri: " + cUri);
                            intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                            intent.setDataAndType(cUri,"video/*");
