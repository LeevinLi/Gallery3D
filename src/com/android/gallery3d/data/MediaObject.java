...
public abstract class MediaObject {
    ...
    public static final int SUPPORT_MOVE = 1 << 19;
    public static final int SUPPORT_RENAME = 1 << 20;
    ...
    public static final String MEDIA_TYPE_SELECTION_STRING = "selection";
    public static final String MEDIA_TYPE_SETTING_STRING = "setting";
    public static final String MEDIA_TYPE_CUSTOM_STRING = "custom";
    ...
    // These are flags for albun status
    public static final int ALBUM_FLAG_HIDDEN = 1;
    public static final int ALBUM_FLAG_SHOW = 0;
    ...
    public static int getTypeFromString(String s) {
        ...
        // add custom type
        if (MEDIA_TYPE_SELECTION_STRING.equals(s)) return MediaObject.MEDIA_TYPE_ALL;
        if (MEDIA_TYPE_SETTING_STRING.equals(s)) return MediaObject.MEDIA_TYPE_ALL;
        if (MEDIA_TYPE_CUSTOM_STRING.equals(s)) return MediaObject.MEDIA_TYPE_ALL;
    ...
    public Uri getContentUri() {
        ...
        Logger.e(TAG, "Class " + className + "should implement getContentUri.");
        Logger.e(TAG, "The object was created from path: " + getPath());
        throw new UnsupportedOperationException();
    }
    ...
    public interface PanoramaSupportCallback {
        void panoramaInfoAvailable(MediaObject mediaObject, boolean isPanorama, boolean isPanorama360);
    }
}
