...
public class ClusterAlbum extends MediaSet implements ContentListener {
    ...
    public ClusterAlbum(Path path, DataManager dataManager, MediaSet clusterAlbumSet, int kind) {
    ...
    public void setImageItemCount(int count) {
        mImageCount = count;
        if (mTimelineTitleMediaItem != null && MediaSet.isShowTimeTitle()) {
