...
public class FilterSource extends MediaSource {
    ...
    public FilterSource(GalleryApp application) {
        ...
        mEmptyItem = new EmptyAlbumImage(Path.fromString(FILTER_EMPTY_ITEM), mApplication);
        mCameraShortcutItem = new CameraShortcutImage(Path.fromString(FILTER_CAMERA_SHORTCUT_ITEM), mApplication);
    }
