...
public class Path implements Parcelable {
    ...
    static void dumpAll(Path p, String prefix1, String prefix2) {
        synchronized (Path.class) {
            ...
            Logger.d(TAG, prefix1 + p.mSegment + ":"
    ...
    public static final Parcelable.Creator<Path> CREATOR
        ...
        public Path createFromParcel(Parcel source) {
            Path parent = source.readParcelable(null);
            String segment = source.readString();
            return new Path(parent, segment);
        }
