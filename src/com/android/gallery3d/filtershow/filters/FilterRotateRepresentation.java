...
public class FilterRotateRepresentation extends FilterRepresentation {
    ...
    public FilterRotateRepresentation(float rotation) {
    ...
    public void setBaseRotation(float rotation) {
    ...
    public void serializeRepresentation(JsonWriter writer) throws IOException {
        writer.beginObject();
        writer.name(SERIALIZATION_ROTATE_VALUE).value(mRotation);
        writer.endObject();
    }
