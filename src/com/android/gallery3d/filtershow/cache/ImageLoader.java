...
public final class ImageLoader {
    ...
    public static String getLocalPathFromUri(Context context, Uri uri) {
        Logger.d(TAG, "getLocalPathFromUri - uri: " + uri);
        Cursor cursor = null;
        try {
            ...
            Logger.e(TAG, "getLocalPathFromUri - err: " + ex.getMessage());
            return null;
        } finally {
    ...
    public static int getMetadataOrientation(Context context, Uri uri) {
        ...
        Logger.d(TAG, "getMetadataOrientation - uri: " + uri);
        ...
        try {
            ...
            try {
                ...
                Logger.w(TAG, "Failed to close InputStream", e);
            }
        }
        return ORI_NORMAL;
    }
    ...
    public static Bitmap loadRegionBitmap(Context context, BitmapCache cache,
        ...
        try {
            ...
            Logger.w(TAG, "FileNotFoundException for " + uri, e);
        } catch (IOException e) {
            Logger.w(TAG, "FileNotFoundException for " + uri, e);
        } catch (IllegalArgumentException e) {
            Logger.w(TAG, "exc, image decoded " + w + " x " + h + " bounds: "
    ...
    public static List<ExifTag> getExif(Context context, Uri uri) {
        ...
        if (path != null) {
            ...
            try {
                ...
                Logger.w(TAG, "Failed to read EXIF tags", e);
            }
        }
        return null;
    }
