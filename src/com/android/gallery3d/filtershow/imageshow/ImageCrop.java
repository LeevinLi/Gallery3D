...
import com.android.gallery3d.filtershow.editors.EditorCropTabletUI;
...
public class ImageCrop extends ImageShow {
    ...
    private void forceStateConsistency() {
        ...
        boolean isCropBack = prefs.getBoolean(EditorCropTabletUI.IS_CROP_BACK, false);
        if (mCropObj == null || (!mUpdateHolder.equals(mGeometry) && !isCropBack)
