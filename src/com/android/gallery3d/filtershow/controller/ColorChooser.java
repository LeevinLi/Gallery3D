...
public class ColorChooser implements Control {
    ...
    @Override
    public void setUp(ViewGroup container, Parameter parameter, final Editor editor) {
        ...
        Button drawClear = (Button) mTopView.findViewById(R.id.draw_color_clear);
        drawClear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((EditorDraw) editor).clearDrawing();
            }
        });
        mIconButton.clear();
