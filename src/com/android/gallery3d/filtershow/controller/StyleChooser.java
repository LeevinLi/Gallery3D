...
public class StyleChooser implements Control {
    ...
    public void setUp(ViewGroup container, Parameter parameter, Editor editor) {
        ...
        lp.rightMargin=20;
        Button drawClear = new Button(context);
        drawClear.setText(context.getText(R.string.draw_clear));
        drawClear.setTextColor(context.getResources().getColor(R.color.white));
        drawClear.setBackgroundColor(context.getResources().getColor(R.color.transparent));
        mLinearLayout.addView(drawClear);
        drawClear.setOnClickListener(new View.OnClickListener() {
            @Override
