...
public class ActionSlider extends TitledSlider {
    ...
    public void setUp(ViewGroup container, Parameter parameter, Editor editor) {
        ...
        mCloseImage = (ImageButton) mTopView.findViewById(R.id.actionCloseButton);
        mCloseImage.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mEditor.getImageShow().getActivity().resetHistory();
            }
        });
        mCheckImage = (ImageButton) mTopView.findViewById(R.id.actionCheckButton);
        mCheckImage.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
